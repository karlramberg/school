...
// Creates the main window and adds the canvas; uses animator to call the GLUT_Canvas object at the specified FPS
public class DrawWindow extends Frame implements KeyListener {

	final static boolean DEBUG_OUTPUT = false;
	final static long serialVersionUID = 0l;

	final public String TITLE = "Textured World"; // window's title
	...
	DrawWindow() {
		...
		canvas = new GLUTCanvas(capabilities, keyBoard, mouse);
