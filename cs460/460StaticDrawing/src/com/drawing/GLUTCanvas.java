...
class GLUTCanvas extends GLCanvas implements GLEventListener {
	...
	public void init(GLAutoDrawable drawable) {
		...
		landscape = new GCircle(50f, -170f, 210f);
		...
		sun = new GCircle(90f, 90f, 5f);
		float sun_color[] = { 0.941f, 0.902f, 0.549f, 0.941f, 0.902f, 0.549f };
		sun.setColor(sun_color);
		
		// Draw two clouds
		small_cloud = new GCloud(70f, 85f, 3f);
		big_cloud = new GCloud(40f, 92f, 5f);
